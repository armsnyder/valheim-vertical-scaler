...
docker-build: ## Build docker image with the manager.
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 GO111MODULE=on go build -a -o bin/manager_linux_amd64 main.go
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 GO111MODULE=on go build -a -o bin/manager_linux_arm64 main.go
	docker build -t ${IMG}-amd64 --platform linux/amd64 --target amd64 .
	docker build -t ${IMG}-arm64 --platform linux/arm64 --target arm64 .
